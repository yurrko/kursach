...
namespace admission_office
{
    class AOffice
    {
        ...
        public bool Create_entrant( string firstName, string lastName, string middleName, string birthDate, List<Exam> list, int education, int eduType )
        {
            using (MySqlConnection connection = new MySqlConnection( ConnectionString.Connection ))
            {
                ...
                cmd.CommandText = "INSERT INTO `admission_office`.`entrance` (`id_entrant`, `id_education`, `id_edu_type, `date`) VALUES (@id_entrant, @id_education, @id_edu_type, @date)";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue( "@id_entrant", lastId );
                cmd.Parameters.AddWithValue( "@id_education", education );
                cmd.Parameters.AddWithValue( "@id_edu_type", eduType );
                var dt = DateTime.Now;
